    ...
    <html lang="en">
      <body>
        <SessionProvider>
          <Navbar />
          <main>{children}</main>
          <footer style={{ background: "var(--navy)", color: "rgba(255,255,255,0.7)" }} className="mt-16 py-10">
            <div className="max-w-7xl mx-auto px-4">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                <div>
                  ...
                  <p className="text-sm mt-1">
                    <a href="https://bbnm.ie" className="hover:text-white transition-colors">bbnm.ie</a>
                  </p>
                </div>
                <div>
                  ...
                  <div className="flex flex-col gap-2 text-sm">
                    ...
                    <a href="/press-releases" className="hover:text-white transition-colors">Press Releases</a>
                ...
                <div>
                  <h4 className="text-white font-semibold mb-3">RSS Feeds</h4>
                  <div className="flex flex-col gap-2 text-sm">
                    <a href="/api/rss" className="hover:text-white transition-colors">All Posts</a>
                    <a href="/api/rss?org=charity" className="hover:text-white transition-colors">Charity Feed</a>
                    <a href="/api/rss?org=business" className="hover:text-white transition-colors">Business Feed</a>
                  </div>
                </div>
                <div>
              ...
              <div className="border-t border-white/20 pt-6 text-sm text-center">
                &copy; {new Date().getFullYear()} Big Bark News & Media. All rights reserved.
              </div>
            </div>
          </footer>
        </SessionProvider>
